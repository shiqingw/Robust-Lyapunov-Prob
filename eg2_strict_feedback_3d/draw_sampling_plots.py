...
def draw_on_nominal_system(exp_num):
    ...
    results_dir = "{}/eg2_results/{:03d}".format(str(Path(__file__).parent.parent), 0)
    if not os.path.exists(results_dir):
        os.makedirs(results_dir)

    # Exp directory
    print("==> Creating result directory ...")
    exp_dir = "{}/eg2_results/{:03d}".format(str(Path(__file__).parent.parent), exp_num)
    if not os.path.exists(exp_dir):
        exp_dir = "{}/eg2_results/{:03d}_keep".format(str(Path(__file__).parent.parent), exp_num)
