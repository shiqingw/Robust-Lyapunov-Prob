...
if __name__ == '__main__':
    ...
    nominal_results_dir = "{}/eg2_results/{:03d}".format(str(Path(__file__).parent.parent), nominal_results_exp_num)
    ...
    def estimated_drift(x):
        ...
        learned_part = drift_nn(x) # (batch_size, state_dim)
        return known_part + learned_part # (batch_size, state_dim)
